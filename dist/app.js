...
console.log(
  `The rental rate for the ${car.getNumSeats()} ${
    car.model
  } is $${car.rentalRate()} per day.`
);
...
console.log(
  `The rental rate for the ${truck.getCargoCapacity()} ${
    truck.model
  } is $${truck.rentalRate()} per day.`
);
...
console.log(
  `The ${motorcycle.make} ${
    motorcycle.model
  } has a ${motorcycle.getEngineSize()}cc engine.`
);
